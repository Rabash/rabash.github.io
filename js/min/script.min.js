...
!function(t,e,n){var i=!(!e||!e.pushState),o={ANCHOR_REGEX:/^#[^ ]+$/,OFFSET_HEIGHT_PX:100,init:function(){this.scrollToCurrent(),window.addEventListener("hashchange",this.scrollToCurrent.bind(this)),t.body.addEventListener("click",this.delegateAnchors.bind(this))},getFixedOffset:function(){return this.OFFSET_HEIGHT_PX},scrollIfAnchor:function(o,r){var s,d,c;return!!this.ANCHOR_REGEX.test(o)&&(s=t.getElementById(o.slice(1)),s&&(d=s.getBoundingClientRect(),c=window.pageYOffset+d.top-this.getFixedOffset(),window.scrollTo(window.pageXOffset,c),i&&r&&e.pushState({},t.title,n.pathname+o)),!!s)},scrollToCurrent:function(){this.scrollIfAnchor(window.location.hash)},delegateAnchors:function(t){var e=t.target;"A"===e.nodeName&&this.scrollIfAnchor(e.getAttribute("href"),!0)&&t.preventDefault()}};window.addEventListener("DOMContentLoaded",o.init.bind(o))}(window.document,window.history,window.location);
!function(){"use strict";var t=(window,document),e=t.documentElement;t.body;e.addEventListener("keyup",function(t){var e=t.which,n=t.target;(9===e||e>36&&e<41)&&n.classList.add("is-tabbed")},!0),e.addEventListener("blur",function(t){var e=t.target;e.classList.remove("is-tabbed")},!0)}();
!function(){"use strict";function t(t){var e=t.getAttribute("data-a11y-toggle"),a=document.getElementById(e);a.setAttribute("aria-hidden",!0),t.setAttribute("aria-expanded",!1)}function e(e){n.filter(function(t){return t!==e.target}).forEach(t)}var a=Array.prototype.slice.call(document.querySelectorAll("a[data-a11y-toggle]"));a.forEach(function(t){t.setAttribute("aria-role","button"),t.setAttribute("onclick","return false")});var n=Array.prototype.slice.call(document.querySelectorAll(".js-connected-toggles [data-a11y-toggle]"));n.forEach(function(t){t.addEventListener("click",e)});var o=window.location.hash.substr(1),r=Array.prototype.slice.call(document.querySelectorAll('[data-a11y-toggle="'+o+'"]'));document.addEventListener("DOMContentLoaded",function(){r.forEach(function(t){t.click()})});var c=document.querySelectorAll('[data-a11y-toggle="search"]');if(c)for(var i=0;i<c.length;i++)c[i].addEventListener("click",function(){var t="open";this.classList&&(this.classList.contains(t)?this.classList&&this.classList.remove(t):(window.setTimeout(function(){document.getElementById("edit-keys").focus()},0),this.classList&&this.classList.add(t)))});var l=document.querySelectorAll('[type="file"]');if(l)for(var s=0;s<l.length;s++)l[s].onchange=function(){this.parentNode.setAttribute("data-text",this.value.replace(/.*(\/|\\)/,""))}}();